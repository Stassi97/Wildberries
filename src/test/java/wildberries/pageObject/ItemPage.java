...
public class ItemPage extends BasePage {
    ...
    private static final Button goToBascket = new Button(By.xpath("//div[@class='product__basket-button-wrapper']//div[@class='basket-button']//button[@data-action='2' and text()='В корзине']"));
